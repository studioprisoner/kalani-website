    ...
    return (
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
            <div className="flex justify-center space-x-6 md:order-2">
              <a href="https://www.facebook.com/Kalani.Co/" class="text-gray-400 hover:text-apricot-peach-500">
              ...
              <a href="https://www.instagram.com/flowersbykalani.co" class="text-gray-400 hover:text-apricot-peach-500">
