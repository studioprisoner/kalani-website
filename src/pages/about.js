        ...
        <div>
            ...
            <div class="relative bg-white mt-1">
                <div class="lg:absolute lg:inset-0">
                    ...
                    <img class="lg:h-56 w-full object-cover lg:absolute lg:h-full" src="../images/jordyn.jpg" alt="" />
                    </div>
                </div>
                <div class="relative pt-12 pb-16 px-4 sm:pt-16 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:grid lg:grid-cols-2">
                    ...
                    <div class="text-base max-w-prose mx-auto lg:max-w-lg lg:ml-auto lg:mr-0">
                        ...
                        <h3 class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-mongoose-500 sm:text-4xl">About Kalani</h3>
