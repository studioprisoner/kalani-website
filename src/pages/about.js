        ...
        <div>
            ...
            <div class="relative bg-white mt-1">
                <div class="lg:absolute lg:inset-0">
                    ...
                    <img class="w-full object-cover lg:absolute lg:h-full" src="../images/jordyn.jpg" alt="" />
                    </div>
                </div>
                <div class="relative pt-12 pb-16 px-4 sm:pt-16 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:grid lg:grid-cols-2">
                    <div class="lg:col-start-2 lg:pl-8">
                    <div class="text-base max-w-prose mx-auto lg:max-w-lg lg:ml-auto lg:mr-0">
                        <h2 class="leading-6 text-rose-bud-500 font-semibold tracking-wide uppercase">Who are we</h2>
                        <h3 class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-mongoose-500 sm:text-4xl">About Kalani.Co</h3>
                        <p class="mt-8 text-lg text-gray-500">My name is Jodyn and I am the owner and creative director of Kalani.Co</p>
                        ...
                        <p>Check out latest products <Link href="/products"><a className="text-base font-semibold underline text-mongoose-500 hover:text-mongoose-700">here</a></Link></p>
                        <h3>What are dried flowers and how do I care for them?</h3>
